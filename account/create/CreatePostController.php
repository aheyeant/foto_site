...
$upload_path = $_ROOT_."/..".Constants::$IMAGES_ASSETS_PATH;
if (Constants::$FEL_SERVER) $upload_path = Constants::$FEL_IMAGES_ASSETS_PATH;
$firm = null;
$model = null;
$price = null;
$description = null;
$image = Constants::$IMAGES_ASSETS_PATH.Constants::$DEFAULT_IMAGE_NAME;
...
if ($_FILES["image"]["error"] == UPLOAD_ERR_OK) {
    ...
    if ($type == "png" or $type == "jpg" or $type == "jpeg") {
        ...
        $image = Constants::$IMAGES_ASSETS_PATH.$file_name;
    }
}
